...
The training process also generated visualization plots saved in the results directory: `results.png` (loss/metrics curves), `confusion_matrix.png`, `PR_curve.png`, etc.
